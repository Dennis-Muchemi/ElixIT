...
export function CaseStudyHeader({ projectId }: CaseStudyHeaderProps) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Fashion Store Redesign
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl">
              A complete overhaul of the online shopping experience for a luxury fashion brand,
              focusing on performance, accessibility, and conversion optimization.
            </p>
          </div>
        </div>
      </div>
